...
// }
//
// SEQUENCE * param_form(int argc, const char * param_set) {
...
//         file = open_file_rb("file.crt");
//     } else if (argc == 4 && (strncmp(argv[1], "-s", 2) != 0)) {
//         file = open_file_rb(argv[3]);
//     } else if (argc == 5) {
//         file = open_file_rb(argv[4]);
//     } else {
...
//     // Обработка файлов
//     FILE *priv_key;
//     priv_key = strncmp(argv[1], "-s") == 0 ?
//         open_file(argc, argv[2]) : open_file(argc, argv[1]);
//     FILE *file;
...
//
//     // 1 Этап
//     int size = fread(buff, sizeof(u8), PARAM_SIZE, f);
//
//
//
//     // 2 Этап
